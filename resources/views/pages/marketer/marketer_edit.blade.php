    ...
    <div class="content">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title ">Edit marketer user {{ $marketer->name }}</h4>
            </div>
            <div class="m-5 align-middle">
                <form method="post" action="{{ url('marketers_list/' . $marketer->id) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="available_balance" class="form-control" id="available_balance"
                            value="{{ $marketer->available_balance }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="card-body">
                        @if ($marketer->profile_image)
                            <img class="card-img-sm-right example-card-img-responsive" style="max-height: 20rem;"
                                src="{{ asset('/mark_images/' . $marketer->profile_image) }}" alt="Image" />
                        @else
                            <img class="card-img-sm-right example-card-img-responsive" style="max-height: 20rem;"
