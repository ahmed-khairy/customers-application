<<!DOCTYPE html>
    ...
    <head>
        ...
        <title>{{ __('Customers Application') }}</title>
    ...
    <body class="clickup-chrome-ext_installed">
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NKDMSK6" height="0"
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item active">
                                        <a class="nav-link" href="{{ route('user.index') }}">
                                            ...
                                            <span class="sidebar-normal"> {{ __('User Management') }}
                                            </span>
                                        </a>
                                    </li>
                                </ul>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        ...
                        <div class="copyright float-right">
                            ...
                            <a href="" target="_blank">Creative Tim</a> and <a
                                href="" target="_blank">UPDIVISION</a> for a
                            better
                            web.
                        </div>
                    </div>
                ...
                <li class="button-container">
                    ...
                    <li class="button-container text-center">
                        ...
                        <button id="facebook" class="btn btn-round btn-facebook"><i
                                class="fa fa-facebook-f"></i> · 50</button>
                        <br>
                        <br>
                    </li> --}}
                </ul>
        ...
        <script src="{{ asset('material') }}/js/plugins/core.js"></script>
